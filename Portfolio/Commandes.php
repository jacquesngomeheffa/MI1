            ...
            <div class="content">
               <form action="<?php echo $editFormAction; ?>" method="post" id="form2" name="form2" >
                <table width="">
                  ...
                  <tr>
                    <td height="60"><h2>E-mail*:</h2></td>
                    <td><div align="center"><span id="sprytextfield1">
                    <input name="Email" type="text" class="inputtextfield" id="Email" size="25" />
                    <span class="textfieldRequiredMsg">Een waarde is verplicht.</span><span class="textfieldInvalidFormatMsg">Ongeldige notatie.</span></span></div></td>
                  </tr>
                </table>
                <p>&nbsp;</p>
                <p align="center">
