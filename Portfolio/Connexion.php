			...
			<div class="title ">
            	<form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
            	  <table width="324" align="center">
            	    <tr>
            	      <td width="166" height="39"><h2>Adresse Email:</h2></td>
            	      <td width="146"><label for="adresEmail"></label>
           	          <input name="adresEmail" type="text" class="inputtextfield" id="adresEmail" /></td>
          	      </tr>
            	    <tr>
            	      <td height="36"><h2>Mot de passe:</h2></td>
            	      <td><label for="motdepasse"></label>
            	  ...
            	  <p align="center">
            	    <input name="Connecter" type="submit" class="cssbutton" id="Connecter" value="Connexion" />
            	  </p>
              </form>
            	<h1>&nbsp;</h1>
            </div>
