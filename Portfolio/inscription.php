...
?>
    ...
    <head>
        ...
        <link href="SpryAssets/SpryValidationConfirm.css" rel="stylesheet" type="text/css" /> </head>
        ...
        <div class="rechtsContainer">
            <div class="page">
                <div class="panel mar-bottom">
                    <div class="title">
                        <h1>&nbsp;</h1>
                        <h1 class="cssbutton align">INSCRIVEZ-VOUS</h1>
                        <p>&nbsp;</p>
                        <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
                            <table width="">
                                <tr>
                                    <td height="60">
                                        <div class="textlabel">Nom*:</div>
                                    </td>
                                    <td><span id="sprytextfield1">
                      <input name="nom" type="text" class="inputtextfield" id="nom" size="25" />
                    <span class="textfieldRequiredMsg">Une valeur est obligatoire.</span></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="60">
                                        <div class="textlabel">Prénom*:</div>
                                    </td>
                    ...
                    <span class="textfieldRequiredMsg">Une valeur est obligatoire.</span></span>
                                ...
                                <tr>
                                    <td height="60">
                                        <div class="textlabel">Numero de telephone*:</div>
                                    </td>
                    ...
                    <span class="textfieldRequiredMsg">Une valeur est obligatoire.</span></span>
                                ...
                                <tr>
                                    <td>
                                        <div class="textlabel">Nom Entreprise:</div>
                                    </td>
                                    <td>
                                        <input name="entreprise" type="text" class="inputtextfield" id="entreprise" size="25" /> </td>
                                </tr>
                                <tr>
                                    <td height="60">
                                        <div class="textlabel">Votre adresse:</div>
                                    </td>
                                    <td>
                                        <input name="adresse" type="text" class="inputtextfield" id="adresse" size="25" /> </td>
                                </tr>
                                <tr>
                                    <td height="60">
                                        <div class="textlabel">Adresse e-mail*:</div>
                                    </td>
                                    <td><span id="sprytextfield4">
                    <input name="email" type="text" class="inputtextfield" id="email" size="25" />
                    <span class="textfieldRequiredMsg">Une valeur est obligatoire.</span><span class="textfieldInvalidFormatMsg">Format non valide.</span></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="60">
                                        <div class="textlabel">Mot de passe*:</div>
                                    </td>
                                    <td><span id="sprypassword1">
                    <input name="motdepasse" type="password" class="inputtextfield" id="motdepasse" size="25" />
                  <span class="passwordRequiredMsg">Une valeur est obligatoire.</span><span class="passwordMinCharsMsg">Er zijn minder dan het minimum aantal tekens.</span></span>
                                </tr>
                                <tr>
                                    <td height="60">
                                        <div class="textlabel">Confirmer mot de passe:</div>
                                    </td>
                                    <td><span id="spryconfirm1">
                      <input name="motdepasse2" type="password" class="inputtextfield" id="motdepasse2" size="25" />
                    <span class="confirmRequiredMsg">Une valeur est obligatoire.</span><span class="confirmInvalidMsg">De waarden komen niet overeen.</span></span>
                                    </td>
                                </tr>
                            </table>
                            <p class="center">
                                <input name="Inscrivez-vous" type="submit" class="cssbutton" id="Inscrivez-vous" value="Inscrivez-vous" /> </p>
