        ...
        <div class="rechtsContainer">
            <div class="page">
                <div id="Facture" class="panel mar-bottom">
                    <div class="title">
                        <h1 class="align">&nbsp;</h1>
                        <h1 class="cssbutton align">VOTRE COMMANDE</h1>
                    </div>
                    <div class="content">
                        <form id="form1" name="form1" method="post" action="">
                            <div class="align">
                                <table width="">
                                    <tr>
                                        ...
                                        <td width="250" height="60">
                                            <h3 class="align">
                                                <?php echo $row_rsApercuCommande['IDclient']; ?>
                                            </h3>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td width="250" height="60">
                                            <h3 class="align">
                                                <?php echo $row_rsApercuCommande['Nom']; ?>
                                            </h3>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td width="250" height="60">
                                            <h3 class="align">
                                                <?php echo $row_rsApercuCommande['Prenom']; ?>
                                            </h3>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td width="250" height="60">
                                            <h3 class="align">
                                                <?php echo $row_rsApercuCommande['Telephone']; ?>
                                            </h3>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td width="250" height="60">
                                            <h3 class="align">
                                                <?php echo $row_rsApercuCommande['Email']; ?>
                                            </h3>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <p class="align">&nbsp;</p>
                            <h1 class="cssbutton align">COMMANDE</h1>
                            <p class="align">&nbsp;</p>
                            <div class="align">
                                <table width="">
                                    <tr>
                                        <td width="250" height="60">
                                            <h2 class="align">Reference</h2>
                                        </td>
                                        <td width="250" height="60">
                                            <h2 class="align">Pièce</h2>
                                        </td>
                                        <td width="250" height="60">
                                            <h2 class="align">Quantité</h2>
                                        </td>
                                        <td width="250" height="60">
                                            <h2 class="align">Date </h2>
                                        </td>
                                    </tr>
                                    <?php do { ?>
                                    <tr>
                                        <td width="250" height="60">
                                            <div class="align">
                                                <?php echo $row_rsApercuCommande['Reference']; ?>
                                            </div>
                                        </td>
                                        <td width="250" height="60">
                                            <div class="align">
                                                <?php echo $row_rsApercuCommande['Nompiece']; ?>
                                            </div>
                                        </td>
                                        <td width="250" height="60">
                                            <div class="align">
                                                <?php echo $row_rsApercuCommande['Quantite']; ?>
                                            </div>
                                        </td>
                                        <td width="250" height="60">
                                            <div class="align">
                                                <?php echo $row_rsApercuCommande['DateDeReservation']; ?>
                                            </div>
                                        </td>
                                    </tr>
                ...
                <div class="align">
                    <input type="button" class="cssbutton" onclick="printdiv('Facture');" value="Imprimer votre facture!" /> </div>
            </div>
            <!---page--->
        </div>
        <!---Rightcol--->
