...
<body>
    ...
    <div class="header-algemeneContainer">
        <div class="header">
            ...
            <div class="menu">
                <ul>
                    <li><a href="index.php" class="active">Page d'acceuil</a></li>
    ...
    <div class="algemeneContainer">
        <div class="linksContainer">
            ...
            <div class="block">
                <div class="panel">
                    <div class="title">
                        <h1 class="align">AUTRE MENU</h1>
                    </div>
                    <div class="content">
                        <ul>

                            <li>
                                <div class="autremenu align"><a href="about.php"> A propos de nous</a></div>
                            </li>
                            <li>
                                <div class="autremenu align"><a href="contact.php"> Contactez-nous </a></div>
                            </li>
                            <li>
                                <div class="autremenu align"><a href="inscription.php"> Inscrivez-vous</a></div>
                            </li>
            ...
            <div class="block2">
                <div class="title">
                    <h1 class="align">LE PERSONNELS</h1>
                </div>
                <div class="panel">
                    <img src="images/image1.png" alt="PDG, Manager" />
                    <div class="content">
                        <p>PDG, Manager </p>
                ...
                <div class="panel">
                    <img src="images/image2.png" alt="Support Manager" />
                    <div class="content">
                        <p>Support Manager</p>
                        <div class="button"><a href="#">More</a></div>
                    </div>
                ...
                <div class="panel bor-bottm-non">
                    <img src="images/image3.png" alt="Gerant-Mecanicien" />
                    <div class="content">
                        <p>Gerant-Mecanicien</p>
                        <div class="button"><a href="#">More</a></div>
                    </div>
                </div>
            </div>
