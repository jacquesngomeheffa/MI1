                ...
                <div class="center">
                    <?php if ($totalRows_rsPieces > 0) { // Show if recordset not empty ?>
                        <table width="" class="table">
                            ...
                            <?php do { ?>
                                <tr>
                                    <td width="300" height="30" class="couleur center">
                                        <?php echo $row_rsPieces['nompiece']; ?>
                                    </td>
                        ...
                        <?php } // Show if recordset not empty ?>
                            <div class="center">
                                <table border="0">
                                    <tr>
                                        <td>
                                            <?php if ($pageNum_rsPieces > 0) { // Show if not first page ?>
                                        ...
                                        <td>
                                            <?php if ($pageNum_rsPieces < $totalPages_rsPieces) { // Show if not last page ?>
